...
export const shows = [
  {
    ...
    characters: [
      ...
      { ...char('Adriana La Cerva', "Christopher's girlfriend caught between love and survival. One of the most tragic figures in the entire series.", '/characters/adrianapic.png', '2026-07-01'), pageImage: '/character-pages/adrianascp.png', packLink: 'https://discord.gg/MVA5ySY2' },
      { ...char('Christopher & Adriana', "Love, lies and loyalty in the shadow of the mob. Their story is one of the most heartbreaking in Sopranos history.", '/characters/chrisandadepic.png', '2026-07-01'), pageImage: '/character-pages/chrisandadescp.png', packLink: 'https://discord.gg/MVA5ySY2' },
    ],
  },
  {
    id: 2,
