...
export default function Footer() {
  return (
    <footer className="relative mt-24" style={{ background: '#0a0704' }}>
      <div style={{ height: '1px', background: 'linear-gradient(90deg, transparent, #5e1b21, #5e1b21, transparent)' }} />
      <div style={{ height: '1px', marginTop: '2px', background: 'linear-gradient(90deg, transparent, rgba(94,27,33,0.3), transparent)' }} />

      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10">
          <div className="text-center md:text-left">
            <div style={{ fontFamily: '"Mobsters","Palatino Linotype",serif', color: '#d4c5a9', fontSize: '2rem', lineHeight: 1 }}>
              Idriss.ae
            </div>
            <div style={{ fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#847464', marginTop: '4px' }}>
              Scenepacks
            </div>
            <p className="mt-3 text-xs max-w-xs leading-relaxed" style={{ color: '#6a5a48', fontFamily: '"IM Fell English",Georgia,serif', fontStyle: 'italic' }}>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[['/', 'Home'], ['/shows', 'Shows'], ['/movies', 'Movies'], ['/request', 'Request'], ['/support', 'Support']].map(([href, label]) => (
                  <div key={href}>
                    <Link href={href} className="text-xs transition-colors" style={{ fontFamily: '"Mobsters","Palatino Linotype",serif', color: '#847464' }}
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="https://discord.gg/MVA5ySY2" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-1.5 text-xs transition-colors" style={{ color: '#847464' }}
                  onMouseEnter={e => e.currentTarget.style.color = '#d4c5a9'}
                  onMouseLeave={e => e.currentTarget.style.color = '#847464'}>
                  <DiscordIcon /> Discord
                </a>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs" style={{ color: '#5a4a38' }}>
            ...
            <span style={{ color: '#6a5a48' }}> on TikTok — </span>
            <span style={{ fontFamily: '"IM Fell English",Georgia,serif', fontStyle: 'italic', color: '#6a5a48' }}>
              Give your credits or sleep with the fishes.
            </span>
          </p>
          <p className="text-xs opacity-35" style={{ fontFamily: '"IM Fell English",Georgia,serif', fontStyle: 'italic', color: '#847464' }}>
